...
display: block;
    content: "";
    /* The image used */
    background-image: url("../adminpanel/assets/img/newlogo.png");
...
<body class="bg">
	...
	<div class="wrapper wrapper-full-page">
        <div class="full-page login-page" filter-color="black" data-image="../adminpanel/assets/img/newlogo.png">
